...
> **Owner: Greg Rothwell. Last updated: 28 August 2026.**

The archived half of [`../TOTAL-RECALL.md`](../TOTAL-RECALL.md), moved here on 28
August 2026 when the spine reached 474 lines against its 300-line budget.
...
The one change made, and it is mechanical: **26 relative links were repointed from
...
would 404. No prose was touched.
...
**Second pass, 29 August 2026.** Seven 28 August entries were moved here
when the spine reached 294 lines against its 300 budget, by the same rule and
with the same one mechanical change — 5 relative links repointed from
`decisions/…` to `../decisions/…`. No prose touched.
